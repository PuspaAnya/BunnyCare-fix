...
public class DetailJenisKelinci extends AppCompatActivity {

    private static final String TAG = "DetailJenisKelinci";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_jenis_kelinci);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotohome = new Intent(DetailJenisKelinci.this, JenisKelinciAct.class);
